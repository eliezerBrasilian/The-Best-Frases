      ...
      <View style={styles.container}>
          ...
          <View style={styles.overBackground}>
            <View style={styles.phraseContainer}>
              <View style={styles.onTop}>
                {data.foto != '' ? (
                  <Image source={{uri: data.foto}} style={styles.authorPhoto} />
                ) : (
        ...
        <View style={styles.footer}>
          <View style={styles.onLeftSide}>
            ...
            />
            <Text style={styles.footerUsernameText}>TheBestFrases</Text>
          </View>
          <View style={styles.onRightSide}>
            <View style={styles.icon_and_amount}>
              {shareLoading ? (
                <ActivityIndicator size={30} color={colors.blue_purple} />
              ) : (
                <TouchableOpacity
            ...
            <View style={styles.icon_and_amount}>
              <TouchableOpacity
                onPress={() => likeSystem(data.key, data.curtidas)}>
                {liked === true ? (
              ...
              {data.curtidas === 0 ? (
                ...
                <Text style={styles.likesText}>{frasesLikes}</Text>
              )}
            </View>
          </View>
        </View>
